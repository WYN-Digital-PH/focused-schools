...
class Fields {
	...
	public static function all() {
		return array(
			...
			'podcast_latest_episode_id'      => array(
				'label'       => __( 'Latest Episode ID', 'focused-schools-core' ),
				'section'     => 'podcast',
				'type'        => 'text',
				'description' => __( 'Optional. The Buzzsprout episode number to feature at the top of the page. Leave empty to hide that section; the full player still lists every episode.', 'focused-schools-core' ),
			),
			'podcast_latest_episode_title'   => array(
				'label'       => __( 'Latest Episode Title', 'focused-schools-core' ),
				'section'     => 'podcast',
				'type'        => 'text',
				'description' => '',
			),
			'podcast_latest_episode_summary' => array(
				'label'       => __( 'Latest Episode Summary', 'focused-schools-core' ),
				'section'     => 'podcast',
				'type'        => 'textarea',
				'description' => '',
			),
