 ...
 *
 * See docs/page-specs/services.md for the full spec.
 *
	...
	while ( have_posts() ) :
		...
		<main id="content">
			...
			get_template_part(
				...
				null,
				array(
					'heading'    => get_the_title() ? get_the_title() : __( 'Our Services', 'focused-schools' ),
					'subheading' => get_the_excerpt() ? get_the_excerpt() : __( 'Structured support for district and school leaders — built around what your team needs most right now.', 'focused-schools' ),
			...
			<section class="fs-services__section fs-container fs-container--shell" aria-labelledby="fs-services-heading">
				...
				// Every published service renders automatically here —
				// editors manage the list entirely via the fs_service CPT
				// admin screen; nothing on this page is ever manually
				// duplicated. See docs/page-specs/services.md §3.
			...
			get_template_part(
				...
				null,
				array(
					'heading'   => __( 'Ready to talk about your team?', 'focused-schools' ),
					'cta_label' => function_exists( 'focused_schools_get_setting' ) && focused_schools_get_setting( 'cta_label' )
